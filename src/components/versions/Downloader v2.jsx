...
const Downloader = () => {
    ...
    try {
      const response =
        downloadMethod === "playlist"
          ...
          : await axios.post("http://localhost:3001/api/v1/downloads/video", {
              url,
            });
      downloadMethod === "playlist"
  ...
  const handleDownload = async (video, type) => {
    ...
    const downloadUrl = `${base}${itag}&startTime=${startTime}&duration=${duration}`;
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="mb-2 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600"
                  />
                  <input
                    type="text"
